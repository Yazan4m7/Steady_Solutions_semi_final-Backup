...
class WorkOrderDetails extends StatefulWidget {
  ...
  WorkOrderDetails(      {Key? key, required this.reportId, required this.notificationedTypeId,required this.forId1})
      : super(key: key);
...
class _WorkOrderDetailsState extends State<WorkOrderDetails> with TickerProviderStateMixin {
  ...
  void getWorkOrderDetails() async {
    print("wo id id is ${widget.reportId}");
    report.value =
