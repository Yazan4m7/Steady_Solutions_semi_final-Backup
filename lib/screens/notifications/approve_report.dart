...
class ViewReport extends StatefulWidget {
  ...
  ViewReport(
      ...
      required this.passedParDate,
      required this.notificationedTypeId,
      required this.forId1})
      : super(key: key);
...
class _ViewReportState extends State<ViewReport> with TickerProviderStateMixin {
                ...
                : Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            "Report : #${report.value.cMReportID}",
                        ...
                        child: ClipRRect(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ReportRow(
                                title:
                                    AppLocalizations.of(context).cm_report_id,
                                value: nullOrEmptyHandler(
                              ...
                              ReportRow(
                                title:
                                    AppLocalizations.of(context).failure_status,
                                value: nullOrEmptyHandler(
                                    report.value.faultStatus.toString()),
                                isEven: true,
                              ),
                              ...
                              report.value.comments != null
                                  ? ReportRow(
                                      title:
                                          "Comments", // AppLocalizations.of(context).comments,
                                      value: nullOrEmptyHandler(
                                          report.value.comments?.toString()),
                                      isEven: false,
                                    )
                                  : SizedBox(),
                            ],
  ...
  Widget _confirmationsButtons(BuildContext context) {
    ...
    return Row(
      mainAxisAlignment: widget.notificationedTypeId == 5
            ...
            : ElevatedButton(
                onPressed: () async {
                  ...
                  if (widget.reportId == 0 ||
                      widget.notificationedTypeId == 0) {
                    Get.dialog(
                      AlertDialog(
                        title: const Text('Error'),
                        content: const Text(
                            "Report ID or Notification ID is missing"),
                        actions: [
                          TextButton(
                            onPressed: () {
                              Get.back();
  ...
  _handleRespnse(String responseMsg) {
    if (responseMsg.toLowerCase() == "success".toLowerCase()) {
      Dialogs.materialDialog(
          ...
          lottieBuilder: Lottie.asset(kMainSuccessIconPath,
